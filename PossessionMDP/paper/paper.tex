...
\fancyhead[R]{\small\itshape Waltzing Analytics}
...
\author{
Waltzing Analytics\thanks{Data and code available in the \texttt{PossessionMDP/} directory of the project repository; see the Data and Code Availability Statement.}\\
...
\begin{table}[htbp]
\centering
\caption{Dataset summary statistics, 2026 Ecuadorian Liga Pro season.}
\label{tab:dataset}
\begin{tabular}{@{}lr@{}}
\toprule
Statistic & Value \\
...
\begin{table}[htbp]
\centering
\caption{Model hyperparameters and state-space cardinality.}
